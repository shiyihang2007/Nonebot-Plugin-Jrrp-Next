...
async def draw_rank(
    ...
    if style == 0:
        ...
        (await _draw_rank_1(data, color)).convert("RGB").save(buffer, "png")
...
if __name__ == "__main__":
    ...
    if style == 0:
        asyncio.run(_draw_rank(data)).convert("RGB").save("tmp.png", "png")
    elif style == 1:
        asyncio.run(_draw_rank_1(data)).convert("RGB").save("tmp.png", "png")
